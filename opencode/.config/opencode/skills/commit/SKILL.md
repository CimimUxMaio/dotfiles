...
- **Never commit changes** unless the user explicitly asks you to. Once the commit requested by the user is done, do not commit any further changes on your own — wait for the user to ask again.
- **Never amend existing commits** without asking.
- **Never push** (including force-push) without explicit user approval.
